...
class CmsLayoutTest < ActiveSupport::TestCase
  ...
  def test_app_layouts_for_select
    FileUtils.touch(File.expand_path('app/views/layouts/admins/cms/nested.html.erb', Rails.root))
    ...
    assert_equal ['admins/cms', 'admins/cms/nested'], Cms::Layout.app_layouts_for_select
    
    FileUtils.rm(File.expand_path('app/views/layouts/admins/cms/nested.html.erb', Rails.root))
