...
class Admins::Cms::RevisionsControllerTest < ActionController::TestCase
  ...
  def test_get_show_for_bad_type
    ...
    assert_response :redirect
    assert_redirected_to admins_cms_path
  ...
  def test_get_show_for_layout_failure
    ...
    assert_response :redirect
    assert assigns(:record)
    assert_redirected_to edit_admins_cms_site_layout_path(site, assigns(:record))
  ...
  def test_get_show_for_page_failure
    ...
    assert_response :redirect
    assert assigns(:record)
    assert_redirected_to edit_admins_cms_site_page_path(site, assigns(:record))
    assert_equal 'Revision Not Found', flash[:error]
  end
  ...
  def test_get_show_for_snippet_failure
    ...
    assert_response :redirect
    assert assigns(:record)
    assert_redirected_to edit_admins_cms_site_snippet_path(site, assigns(:record))
    assert_equal 'Revision Not Found', flash[:error]
  end
  ...
  def test_revert_for_layout
    ...
    assert_difference 'layout.revisions.count' do 
      ...
      assert_response :redirect
      assert_redirected_to edit_admins_cms_site_layout_path(layout.site, layout)
  ...
  def test_revert_for_page
    ...
    assert_difference 'page.revisions.count' do
      ...
      assert_response :redirect
      assert_redirected_to edit_admins_cms_site_page_path(page.site, page)
      assert_equal 'Content Reverted', flash[:success]
  ...
  def test_revert_for_snippet
    ...
    assert_difference 'snippet.revisions.count' do
      ...
      assert_response :redirect
      assert_redirected_to edit_admins_cms_site_snippet_path(snippet.site, snippet)
      assert_equal 'Content Reverted', flash[:success]
